...
from quibbles import create_app, db

# from quibbles.models import User, Quibble, Tag
from flask_script  import Manager
from flask_migrate import Migrate, MigrateCommand

app = create_app(os.getenv('QUIBBLES_ENV') or 'dev')
...
#     add_quibble("Why do Java Programmers wear glasses? Because they don't see sharp.",
#                 "Programmers", "java,programmer")
